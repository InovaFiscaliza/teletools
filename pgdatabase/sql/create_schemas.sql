...
BEGIN
    ...
    FOR i IN 1..array_length(schemas_list, 1) LOOP
        ...
        BEGIN
            ...
            -- Altera privilégios padrão para funções
            ...
            -- Altera privilégios padrão para tipos
